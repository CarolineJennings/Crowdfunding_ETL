...
The ETL mini project, showcases building an ETL pipeline using Python, Pandas, and Python dictionary methods to extract and transform the data. After transforming the data, four CSV files are created and the data used to create an ERD and a table schema. And then upload the CSV files data into a Postgres database.


# Download the starter code and files to help you get started:

# To Begin
Create a new repository, named Crowdfunding_ETL, for this project.
